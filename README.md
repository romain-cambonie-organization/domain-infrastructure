...
domain infrastructure décrit par le code un aspect de l'infrastructure à provisionner pour romain-cambonie.
...
- [Github Actions](https://docs.github.com/en/actions) est l'outil d'intégration et de déploiement continu intégré à GitHub
    - L'historique des déploiements est disponible [sous l'onglet Actions](https://github.com/romain-cambonie-organization/domain-infrastructure/actions/)
- Secrets du dépôt :
...
- [AWS](https://aws.amazon.com/) est la plateforme de services Cloud proposée par Amazon.
    - Utilisateur : `romain-cambonie.domain.infrastructure`
...
- [Terraform Cloud](https://app.terraform.io/) est la plateforme proposée par HashiCorp pour administrer les modifications d'infrastructure
    ...
    - Workspaces : `domain`
        - [domain](https://app.terraform.io/app/romain-cambonie-organization/workspaces/domain)
    - Variables
